<?php
namespace Custom\CustomBundle\Reader\File;
 ...
 */
class CustomReader extends AbstractConfigurableStepElement implements ItemReaderInterface, StepExecutionAwareInterface
{
    /** @var AbstractQuery */
    protected $query;
    ...
    {
file_put_contents(dirname(__FILE__).'/errordoc.txt', $this->executed()); return;
        if (!$this->executed) {
            $this->executed = true;
